    ...
    <article className="post">
      <header className="post__header">
        <div className="post__header-inner">
          <h1>The end is the beginning</h1>
          <p>
      ...
      <section className="work__preview__body">
        <div className="work__preview__container">
          ...
          <p className="col__left">
            Creating todos are my jam and most likely they are yours too. For a whole lot
            of us there is a joyous feeling of being organized and having things todo. But
            simply, we hate actually doing them. Creating todos are my jam and most likely
            they are yours too. For a whole lot of us there is a joyous feeling of being
            organized and having things todo. But simply, we hate actually doing them.
