    ...
    return (
      <div className="site-container__inner home bg-purple text-white">
        <Transition location={this.props.location}>
          ...
          <main
            className="relative pb-48 flex flex-col"
            role="main"
          ...
          >
              ...
              <section className="flex flex-col md-flex-row justify-between mx-auto max-w-xl md-mb-64 px-4">
                <div className="w-full mx-auto md-mx-0 md-w-1-2 max-w-xssm">
                  ...
                  <p className="text-3xl leading-normal font-thin text-shadow mb-8">
                    When I’m not at work… I’m probably still working, just on my own
                    projects. 👨‍💻
                  </p>
                  <List
                    items={null}
            ...
            <p className="text-xl leading-loose md-text-3xl max-w-lg mx-auto px-4 lg-px-0 md-leading-normal font-thin text-shadow mb-24">
              ...
              you’re interested in bringing me on your team or need help with a project,
              take a look at my{' '}
              <a
